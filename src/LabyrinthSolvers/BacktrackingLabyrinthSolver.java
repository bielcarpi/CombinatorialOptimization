...
public class BacktrackingLabyrinthSolver extends AbstractLabyrinthSolver{
    ...
    public BacktrackingLabyrinthSolver(boolean renderGraphics) {
    ...
    protected List<Direction> solve(Cell[][] cells) {
        this.cells = cells;
        backtracking(STARTING_X_COORD, STARTING_Y_COORD);
        return bestSolution;
    }
